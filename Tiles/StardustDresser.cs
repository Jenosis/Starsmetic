...
{
    public class StardustDresser : ModTile
    {
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.showItemIcon2 = mod.ItemType("StardustDresser");
        ...
        {
            Item.NewItem(i * 16, j * 16, 48, 32, mod.ItemType("StardustDresser"));
        }
    }
}