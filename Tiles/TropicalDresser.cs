...
{
    public class TropicalDresser : ModTile
    {
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.showItemIcon2 = mod.ItemType("TropicalDresser");
        ...
        {
            Item.NewItem(i * 16, j * 16, 48, 32, mod.ItemType("TropicalDresser"));
        }
    }
}