...
{
    public class MoonsetterDresser : ModTile
    {
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.showItemIcon2 = mod.ItemType("MoonsetterDresser");
        ...
        {
            Item.NewItem(i * 16, j * 16, 48, 32, mod.ItemType("MoonsetterDresser"));
        }
    }
}