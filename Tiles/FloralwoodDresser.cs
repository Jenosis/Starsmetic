...
{
	public class FloralwoodDresser : ModTile
	{
		public override void SetDefaults()
		{
			...
			dresser = "Floralwood Dresser";
			dresserDrop = mod.ItemType("FloralwoodDresser");
		}
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.showItemIcon2 = mod.ItemType("FloralwoodDresser");
